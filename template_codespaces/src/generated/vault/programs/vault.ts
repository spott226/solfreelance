...
export const VAULT_PROGRAM_ADDRESS =
  "FinQpN2cyfhNKHVX2LjPRqg7V4JUcPXZ5ipLSSrHFBJJ" as Address<"FinQpN2cyfhNKHVX2LjPRqg7V4JUcPXZ5ipLSSrHFBJJ">;
...
export type ParsedVaultInstruction<
  TProgram extends string = "FinQpN2cyfhNKHVX2LjPRqg7V4JUcPXZ5ipLSSrHFBJJ",
> =
  | ({
